...
//import { Chart } from 'https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.8.0/chart.js';
...
const uid = process.env.UID; // Id de usuario do login/nodeMCU
const email = process.env.EMAIL; // Usuario de acesso ao firebase
const senha = process.env.SENHA_FIREBASE; // Senha de acesso ao firebase
